pipeline {
  ...
  stages {
    ...
    stage('SonarQube Analysis') {
      steps {
        sh 'mvn clean org.jacoco:jacoco-maven-plugin:prepare-agent install sonar:sonar -Dsonar.host.url=http://13.41.240.178:9000/ -Dsonar.login=squ_221488436db06b49f4a178e93126a190cc3d5472'
      }
    }
